# Домашнее задание к занятию «Уязвимости и атаки на информационные системы» Егоров Дмитрий.
...
UDP-Трафик идет в одну сторону отправляются UDP пакеты, но ответа (как в TCP) на установление соединения не ожидается.  
![Alt text](screenshot/UDP.png)
